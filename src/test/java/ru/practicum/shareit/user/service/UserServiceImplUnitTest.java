...
class UserServiceImplUnitTest {
    ...
    @Test
    void shouldThrowValidationExceptionIfEmailEmptyInAddUser() {
        UserService userService = new UserServiceImpl(userDao);

        assertThrows(ValidationException.class, () -> userService.addUser(new UserDto(0, "", "user1")), "email fail");
    }

    @Test
    void shouldThrowValidationExceptionIfEmailSpaceInAddUser() {
        UserService userService = new UserServiceImpl(userDao);
    ...
    @Test
    void shouldThrowValidationExceptionIfEmailNullInAddUser() {
        UserService userService = new UserServiceImpl(userDao);

        assertThrows(ValidationException.class, () -> userService.addUser(new UserDto(0, null, "user1")), "email fail");
    }

    @Test
    void shouldThrowValidationExceptionIfEmailWithoutDogSymbolInAddUser() {
        UserService userService = new UserServiceImpl(userDao);

        assertThrows(ValidationException.class, () -> userService.addUser(new UserDto(0, "op#pa.ru", "user1")), "email fail");
    }
